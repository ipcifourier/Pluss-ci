...
class TeamMemberResource extends Resource
{
    ...
    protected static string|\UnitEnum|null $navigationGroup = 'Equipe et Utilisateurs';

    protected static ?string $recordTitleAttribute = 'team';

    public static function form(Schema $schema): Schema
    {
        //return TeamMemberForm::make($schema);
        return $schema->schema(TeamMemberForm::schema());
    }

    public static function table(Table $table): Table
    {
        //return TeamMembersTable::make($table);
        return TeamMembersTable::table($table);
    }
