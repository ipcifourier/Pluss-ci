            ...
            <article class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-6">
                        ...
                        @if ($article->category)
                            <span
                                class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full font-medium text-xs uppercase tracking-wide">
                                {{ $article->category }}
                            </span>
                        @endif
                        ...
                        {{-- GTT (Lien sécurisé) --}}
                        @if ($article->gtt)
                            <a href="{{ route('gtts.show', $article->gtt) }}"
                                class="flex items-center gap-1 text-brand-orange font-bold hover:underline bg-brand-orange/10 px-3 py-1 rounded-full text-xs uppercase tracking-wide transition">
                    ...
                    <section class="mt-12 border-t pt-8">
                        ...
                        <div class="mt-8 bg-white p-6 rounded-lg border border-gray-200">
                            ...
                            <form action="{{ route('articles.comment', $article) }}" method="POST">
                                ...
                                <button type="submit"
                                    class="bg-brand-orange text-white font-semibold px-6 py-2 rounded-lg hover:bg-orange-600 transition">
                    ...
                    <div class="mt-12 pt-8 border-t border-gray-100">
                        <a href="{{ route('articles.index') }}"
                            class="inline-flex items-center text-brand-green font-bold hover:underline gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
