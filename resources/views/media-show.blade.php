<x-layout>
    ...
    <div class="relative h-64 md:h-80 overflow-hidden bg-gray-900">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
            <span
                class="mb-4 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-white text-gray-900 shadow-lg">
                @if ($media->type === 'video')
                    📺 Vidéo
    ...
    <div class="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 p-6 md:p-10">
            ...
            @if ($media->type === 'audio' && $media->audio_file)
                <div class="bg-gray-50 rounded-xl p-6 mb-8 border border-gray-200">
                    ...
                    <audio controls class="w-full h-12 rounded-lg">
                        <source src="{{ asset('images/' . $media->audio_file) }}" type="audio/mpeg">
                ...
                <div class="relative pb-[56.25%] mb-8 rounded-xl overflow-hidden bg-black shadow-lg">
                    <div class="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <a href="{{ $media->video_url }}" target="_blank" rel="noopener noreferrer"
                            class="bg-red-600 text-white px-6 py-3 rounded-full font-bold hover:bg-red-700 transition flex items-center gap-2">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            @foreach ($images as $imagePath)
                                <div
                                    class="group relative aspect-square overflow-hidden rounded-xl cursor-pointer bg-gray-100">
                                    <img src="{{ asset('images/' . $imagePath) }}" alt="Photo" loading="lazy"
            ...
            <div class="mt-12 pt-6 border-t border-gray-100">
                <a href="{{ url('/') }}"
                    class="inline-flex items-center text-gray-500 hover:text-brand-orange transition font-semibold">
                    ← Retour à l'accueil
                </a>
            </div>
