        ...
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="prose prose-lg max-w-none">
                ...
                <p class="text-gray-700 leading-relaxed text-justify">
                    La Côte d'Ivoire est un pays situé sur la côte de l'Afrique de l'Ouest avec une population de 29 389
                    millions d'habitants. Dans le cadre de la mise en œuvre du Règlement Sanitaire International (RSI),
                    la Côte d'Ivoire a adhéré au Programme de Sécurité Sanitaire Mondiale (GHSA). GHSA est une
                    initiative multisectorielle qui vise à renforcer la capacité du pays à prévenir, détecter et
                    répondre aux menaces sanitaires, que ces menaces soient d'origine animale, humaine ou
                    environnementale, à travers l'approche « Une Seule Santé ».
                </p>
                <p class="text-gray-700 leading-relaxed mt-4 text-justify">
                    ...
                    prioritaires à potentiel épidémique ou maladies zoonotiques prioritaires (MZP). Sous la direction du
                    groupe de travail technique sur la communication des risques, les parties prenantes de Une Seule
                    Santé ont élaboré une stratégie de communication nationale pour permettre aux populations de prendre
                    les décisions appropriées face à ces menaces sanitaires.
                </p>
            </div>
        </div>
    </section>
                    ...
                    @foreach ($zoonoses as $zoonose)
                        <div x-data="{ open: false }"
                            ...
                            <button @click="open = !open"
                                class="w-full text-left px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-300"
                                ...
                                <div class="px-6 py-5">
                                    @if ($zoonose->description_courte)
                                        <p class="text-gray-600 italic mb-4 border-l-4 border-brand-orange pl-4">
                                            {{ $zoonose->description_courte }}</p>
                                    @endif

                                    @if ($zoonose->image_illustration)
                                        <img src="{{ asset('images/' . $zoonose->image_illustration) }}"
                                            alt="{{ $zoonose->titre }}"
                                            class="w-full max-w-md h-auto object-cover rounded-lg mb-4 mx-auto">
                                    @endif
    ...
    <section class="py-12 bg-white border-t border-gray-100">
        <div class="container mx-auto px-4 text-center">
            <p class="text-gray-600 mb-4">
                Pour plus de détails, consultez la <span class="font-semibold">stratégie nationale de communication pour
                    les risques liés aux cinq groupes de zoonoses prioritaires en Côte d'Ivoire (2019-2022)</span>.
            </p>
